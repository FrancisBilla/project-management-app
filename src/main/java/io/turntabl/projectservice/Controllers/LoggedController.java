...
public class LoggedController implements LoggedDAO {
    ...
    public Map<String, Object> getAllLoggedVacation() {
        ...
        try {
            List<LoggedVacTO> vac = jdbcTemplate.query(
                    "select * from LoggedVacation", BeanPropertyRowMapper.newInstance(LoggedVacTO.class));
    ...
    @Override
    public Map<String, Object> addLoggedVacation(@RequestBody LoggedVacTO loggedVacationTO) {
        Map<String, Object> response = new HashMap<>();
        try{
